...
public class RegularUser : User
{
    ...
    /// </summary>
    public uint MoneyLeft { get; private set; }
    ...
    public bool HasEnoughMoney(uint price) => MoneyLeft >= price;
    ...
    public void RemoveMoney(uint price)
    {
        checked
        {
            MoneyLeft -= price;
    ...
    public ulong CalculateMoneySpent()
    {
        ulong res = 0;
